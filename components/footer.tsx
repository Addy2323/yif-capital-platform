      ...
      <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="https://facebook.com" target="_blank" className="text-white/60 hover:text-white transition-colors">
            ...
            <Link href="https://youtube.com" target="_blank" className="text-white/60 hover:text-white transition-colors">
